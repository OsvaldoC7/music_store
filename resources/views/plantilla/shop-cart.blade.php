                            ...
                            <tbody>
                                <tr>
                                    <td class="cart__product__item">
                                        <img src="{{asset('plantilla/img/shop-cart/cp-1.jpg')}}" alt="">
                                ...
                                <tr>
                                    <td class="cart__product__item">
                                        <img src="{{asset('plantilla/img/shop-cart/cp-2.jpg')}}" alt="">
                                        <div class="cart__product__item__title">
                                ...
                                <tr>
                                    <td class="cart__product__item">
                                        <img src="{{asset('plantilla/img/shop-cart/cp-3.jpg')}}" alt="">
                                        <div class="cart__product__item__title">
                                            <h6>Black jean</h6>
                                            <div class="rating">
                                                <i class="fa fa-star"></i>
                                ...
                                <tr>
                                    <td class="cart__product__item">
                                        <img src="{{asset('plantilla/img/shop-cart/cp-4.jpg')}}" alt="">
                                        <div class="cart__product__item__title">
                                            <h6>Cotton Shirt</h6>
                                            <div class="rating">
                                                <i class="fa fa-star"></i>
